...
namespace NawafizApp.Services.Dtos.Validators
{
    public class LanguageValidator : AbstractValidator<LanguageDto>
    {
        ...
        public LanguageValidator(ILanguageService languageService, IUserService userService)
        {
            ...
            RuleSet("Add", () =>
            {
                RuleFor(m => m.Code).SetValidator(new IsCodeUniqueAddPropertyValidator(_languageService));
                //Custom(m =>
                //{
            ...
            RuleSet("Edit", () =>
            {
                ...
                RuleFor(m => m.Code).SetValidator(new IsCodeUniqueEditPropertyValidator(_languageService));
                //Custom(m =>
                //{
