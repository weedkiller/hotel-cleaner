...
{
    public class GuideIsEnglishNameAddUniquePropertyValidator : PropertyValidator
    {
        public readonly IGuideCityService _GuidecityService;
        public GuideIsEnglishNameAddUniquePropertyValidator(IGuideCityService GuideCityService)
        ...
        protected override bool IsValid(PropertyValidatorContext context)
        {
            ...
            return _GuidecityService.IsNameUnique(m.EnglishCityName,null);
        }
    }
}
